    ...
    return (
        <article key={message.id} className="flex items-start gap-2.5 my-6">
            ...
            <div className="flex flex-col gap-1">
                ...
                <div className="flex flex-col w-full max-w-[640px] leading-1.5 p-4 border-gray-200 bg-lightorange rounded-e-xl rounded-es-xl dark:bg-gray-700">
                    <p className="text-sm font-normal text-gray-900 dark:text-white pb-3">You added a document:</p>
                    <div className="flex items-start bg-orange dark:bg-gray-600 rounded-xl p-2">
                        ...
                        <div className="inline-flex self-center items-center">
                            <a href={document.originalPath} target="_blank" className="inline-flex self-center items-center p-2 text-sm font-medium text-center text-gray-900 bg-lightorange rounded-lg hover:bg-darkorange focus:ring-4 focus:outline-none dark:text-white focus:ring-gray-50 dark:bg-gray-600 dark:hover:bg-gray-500 dark:focus:ring-gray-600" type="button">
...
function GetDocumentIcon({ document }: { document: IDocumentProperties }) {
    ...
    switch (document.extension) {
        ...
        case 'docx':
            return (
                <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="darkblue" viewBox="0 0 24 24">
