function DocumentUploadedMessage() {
    return (
            ...
            <img className="w-8 h-8 rounded-full" src="/user.png" alt="User profile picture" />
                <div className="flex flex-col gap-1">
                    ...
                    <div className="badges">
                        <span className="text-sm font-normal text-gray-500 dark:text-gray-400">Tagged as </span>
                        <span id="badge-dismiss-default" className="inline-flex items-center px-2 py-1 me-2 text-sm font-normal text-blue-800 bg-blue-100 rounded dark:bg-blue-900 dark:text-blue-300">
                            Hover
...
export default DocumentUploadedMessage;