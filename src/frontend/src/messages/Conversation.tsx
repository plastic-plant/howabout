...
export default function Conversation() {
    ...
    const isLastmessageByUserWaitingForResponse = messages.length > 0 && messages[messages.length - 1].role == 'user';
...
function ConversationMessageComponent({ message }: { message: IConversationMessage }) {
